...
export function demoData(): FinanceData {
  ...
  data.accounts = [
    ...
    },
    {
      id: "demo-pillar",
      name: "Prévoyance 3a",
      institution: "Assurance Exemple",
      kind: "savings",
      group: "3e pilier",
      currency: "CHF",
      valuationMode: "total",
      source,
      balances: [{ id: "b4", amountMinor: 1850000, asOf: date, source }],
    },
    {
      id: "demo-child",
      name: "Compte de Mia",
      ...
      valuationMode: "total",
      source,
      balances: [{ id: "b5", amountMinor: 420000, asOf: date, source }],
    },
  ];
  for (let i = 5; i > 0; i--) {
    const d = new Date(
    ...
    data.accounts.forEach((a, k) =>
      a.balances.unshift({
        id: `history-${k}-${i}`,
        amountMinor:
          [1284500, 3650000, 4815000, 1850000, 420000][k] -
          i * [17000, 80000, 96000, 60000, 15000][k],
        asOf: at,
        source,
      }),
    );
